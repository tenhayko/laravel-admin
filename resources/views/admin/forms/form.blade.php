...
<!-- jQuery -->
    ...
    <!-- Switchery -->
    <script src="admin_asset/vendors/switchery/dist/switchery.min.js"></script>
    <!-- Select2 -->
    ...
    <!-- starrr -->
    <script src="admin_asset/vendors/starrr/dist/starrr.js"></script>
...
@section('style')
    ...
    <!-- bootstrap-wysiwyg -->
    <link href="admin_asset/vendors/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
    <!-- Select2 -->
    ...
    <!-- starrr -->
    <link href="admin_asset/vendors/starrr/dist/starrr.css" rel="stylesheet">
    <!-- bootstrap-daterangepicker -->
