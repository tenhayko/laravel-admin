...
@section('script')
    ...
    <!-- jQuery Sparklines -->
    <script src="admin_asset/vendors/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
    <!-- easy-pie-chart -->
    <script src="admin_asset/vendors/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
